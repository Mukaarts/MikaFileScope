#!/usr/bin/env swift
// compose.swift — setzt die rohen Fensteraufnahmen zu fertigen App-Store-Bildern zusammen.
//
// Aus screenshots/raw/<sprache>/NN_name.png wird
// screenshots/<locale>/<format>/NN_name.jpg: Markenhintergrund, Headline, Subline
// und das Fenster in einem Rahmen.
//
...
// (scripts/GenerateOGImage.swift, GenerateIcon.swift) und weil SF Pro nur über
// AppKit in allen Schnitten zur Verfügung steht — Pillow müsste die variable
// Systemschrift instanziieren.
//
...
let hellUnten  = NSColor(srgbRed: 0xDF/255.0, green: 0xF0/255.0, blue: 0xE8/255.0, alpha: 1)
let dunkelOben = NSColor(srgbRed: 0x14/255.0, green: 0x2A/255.0, blue: 0x24/255.0, alpha: 1)
let dunkelUnten = NSColor(srgbRed: 0x0A/255.0, green: 0x14/255.0, blue: 0x11/255.0, alpha: 1)
...
let creme      = NSColor(srgbRed: 0xEC/255.0, green: 0xF7/255.0, blue: 0xF2/255.0, alpha: 1)
let cremeMatt  = NSColor(srgbRed: 0xA8/255.0, green: 0xC4/255.0, blue: 0xB9/255.0, alpha: 1)
